...
list(
    ...
    tar_target(experiments,         c("historical", "ssp126", "ssp534-over", "ssp585"))
    ...
    ,tar_target(resotempo,          list(   vars = c("SST",  "CHLA", "BATHY"), 
                                            reso = c("week", "week", "FIXE"))) 
    ...
    ,tar_target(renameVar,          list(   oldname = c("to", "chl", "topo"), 
                                            newname = c("SST", "CHLA", "BATHY")))
    ...
    # ,tar_target(climato_cmip, climato_cmip(speedCompo_cmip), format = "file")
    # ,tar_target(mergeHistorical_cmip, mergeHistorical_cmip(climato_cmip), format = "file")
    ...
    # Shaping copernicus data (observed)
