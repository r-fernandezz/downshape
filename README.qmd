...
## Data folder
:heavy_check_mark: **[copernicus_parameters.csv]** : csv file. Parameters of data we want dto download. Check table structuration bellow. If variable have big size, Copernicus api can't to download and it's necessary to divided variable in several small time periods (use "divide", "subvar" and "septime" argument of copernicus_download_api() function)
