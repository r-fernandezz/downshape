...
:heavy_check_mark: **[ano_vars]** : character. Name of the variable with which you want to calculate the anomaly. This calculation uses the climatology of the same variable, and the climatology file name must be the same as the variable in the output folder with this format: 'SST0x100_climatology_XX.tif'.
